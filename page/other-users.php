<?php
 ...
 <html lang="en" dir="ltr">
   <head>
     ...
     <link href="../css/search-user.css" type="text/css" rel="stylesheet">
     ...
     <title>Search users - MyThing</title>
   </head>
   <body>
     ...
     <div class="nav-main-container">
       ...
       <div class="nav-container">
         <div class="menu">
           ...
           <li id="li-search" class="active"><a href="#"><span class="fas fa-search"></span></a></li>
         </div>
       </div>
      ...
      <?php
             ...
             if(isset($row['ID'])) {
               if($row['no_pic'] == 1) {
                 echo "<img src='../content/userDefault.png' id='home-feed-pic' alt='User Pic'>";
                   ...
                   echo "<img src='../user_picture_uploads/".$row['profile_pic_path']."' id='home-feed-pic' alt='User Pic'>";
                   }
                 }
               ?>
           </div>
           <div class="home-feed-followers" >
             <?php
               $id = $userid;
               $sql = "SELECT * FROM tbl_vid_uploads WHERE userID = '$id'";
           ...
           <div class="full-name">
             <li style="margin-left:20px"><strong><?php echo $row['firstname'] ?></strong></li>
             <li><strong><?php echo $row['lastname'] ?></strong></li>
           </div>
         </div>
           ...
           <div class="user-vid-feed">
             <div class="vid-list">
               ...
               while($row = mysqli_fetch_assoc($result)) {
                 ...
                 echo "<li>";
                 echo "<video src='".$folder."".$videoPath."' controls></video>";
                 echo "</li>";
                 echo "</ul>";
               }
               ?>
